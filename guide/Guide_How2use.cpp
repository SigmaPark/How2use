...
static void intro(){
	h2u::mdo << h2u::Title(L"Introduction") <<
...
static void Math_Expression(){
	h2u::mdo << h2u::Title(L"Math Expression") << 
...
static void Code_Block(){
	h2u::mdo << h2u::Title(L"Code Block") << 
...
static void Assertions(){
	h2u::mdo << h2u::Title(L"Helper Functions for Assertion") <<
	...
	h2u::mdo << h2u::Title(L"H2U_ASSERT", 2) <<
...
END_CODE_BLOCK_AND_LOAD(is_true_ex)
	...
	h2u::mdo << h2u::Title(L"h2u::Are_All_True / h2u::Are_N_True", 2) <<
	...
	h2u::mdo << h2u::Title(L"h2u::Are_All_Equivalent_to / h2u::Are_N_Equivalent_to", 2) <<
...
END_CODE_BLOCK_AND_LOAD(are_all_equivalent_ex)
	...
	h2u::mdo << h2u::Title(L"h2u::Are_Equivalent_Ranges", 2) <<
...
static void Specimen_and_State(){
	...
	h2u::mdo << h2u::Title(L"State Flag for Lifecycle Tracking", 3) <<
	...
	h2u::mdo << h2u::Title(L"Move Semantics Verification", 3) <<
...
static void Specimen_Log_Tracking(){
	h2u::mdo << h2u::Title(L"Testing with Specimen Logger", 2) <<
	...
	h2u::mdo << h2u::Title(L"Recording Logger Implementation", 3) <<
...
END_CODE_BLOCK_AND_LOAD(recording_logger_impl)
	...
	h2u::mdo << h2u::Title(L"Testing Template Behavior", 3) <<
...
END_CODE_BLOCK(descrip_file_ex)
	...
	h2u::mdo << h2u::Title(L"Image File", 2) <<
...
END_CODE_BLOCK(img_ex)
	...
	h2u::mdo << L"The 2nd parameter means image width to show " <<
...
BEGIN_CODE_BLOCK(md_guard_ex)
	{
		...
		h2u::mdo << L"Until \"mbg\" is alive(before its destructor is excuted), " <<
...
END_CODE_BLOCK(md_guard_ex)
	...
	h2u::mdo << h2u::newl << h2u::Title(L"HTML Guard", 2) << 
...
static void Literal_Suffixes(){
	h2u::mdo << h2u::Title(L"Literal Suffixes") <<
...
END_CODE_BLOCK(mdo_suffix_ex)
	...
	h2u::mdo << h2u::Title(L"\"\"_code for Pseudo Code", 2) <<
